...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {const schema = __webpack_require__(1);
	const processJSON = __webpack_require__(8);
...
/***/ function(module, exports) {
	...
	JSONEditor.defaults.editors.string = JSONEditor.AbstractEditor.extend({
	  ...
	  build: function() {
	    ...
	    this.control = this.theme.getFormControl(this.label, this.input, this.description, this.options.infoText ? this.options.infoText : undefined);
	...
	JSONEditor.defaults.editors.base64 = JSONEditor.AbstractEditor.extend({
	  ...
	  build: function() {
	    ...
	    this.control = this.theme.getFormControl(this.label, this.uploader||this.input, this.preview, this.options.infoText ? this.options.infoText : undefined);
	    this.container.appendChild(this.control);
	  },
	...
	JSONEditor.defaults.themes.bootstrap3 = JSONEditor.AbstractTheme.extend({
	  ...
	  getFormControl: function(label, input, description, infoText) {
	    ...
	    if(label && input.type === 'checkbox') {
	      ...
	      if(infoText) group.appendChild(this.getInfoButton(infoText));
